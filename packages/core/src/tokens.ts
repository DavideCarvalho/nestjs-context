// Follows the canonical capability('context', 'options') naming convention from @dudousxd/nestjs-diagnostics.
 ...
 *
 * Follows the canonical capability('context', 'accessor') naming convention from @dudousxd/nestjs-diagnostics.
 */
